...
async function generateTakes(story) {
  const prompt = `You are writing two short fantasy football in-season dispatches for The Inner Sanctum, based on this real, dated news item:
...
{
  "oracle": {
    "title": "The Oracle's Dispatch — <short subject, e.g. player or team + topic>",
