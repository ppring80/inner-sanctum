// netlify/functions/weekly-sage-wr-validation.js
//
// WEEKLY SAGE — WR HISTORICAL VALIDATION
//
// PURPOSE
// -------
// Compare the PRE-GAME Weekly SAGE WR forecast against what
...
//
//   Prediction:
//     weekly-sage-wr-leaderboard?week=8
...
// -----------------
//
// For each WR who actually played:
//
//   playerID
//   name
//   team
...
//
// BYE
//   Already excluded from weekly-sage-wr-leaderboard.
//
// DID NOT PLAY
...
async function fetchLeaderboard({
  ...
  if (
    ...
    throw new Error(
      "Unexpected Weekly SAGE WR leaderboard schema."
    );
  }
    ...
    */
    ...
    try {
      ...
      /*
        STEP 1
        ------
        Retrieve the frozen PRE-GAME Weekly SAGE WR leaderboard.
      ...
      */
      ...
      if (
        ...
        return jsonResponse(
          ...
          {
            error:
              "Weekly SAGE WR leaderboard contains no active WRs."
          }
        );
      }
      ...
      */
      if (
        ...
        return jsonResponse(
          ...
          {
            error:
              "Weekly SAGE WR leaderboard is not clean enough for historical validation.",
      ...
      */
      ...
      /*
        STEP 3
        ------
        Add actual WR finish ranks in all three scoring systems.
      */
      addActualRanks(
        validation
      );
      ...
      */
      ...
      /*
        STEP 4
        ------
        Measure the untouched WR SAGE v1 forecast.
      ...
      */
      ...
      return jsonResponse(
        200,
        {
          ...
          methodology: {
            ...
            prediction:
              `Weekly SAGE WR Week ${targetWeek} scores generated using only evidence available before Week ${targetWeek}.`,
            ...
            important:
              "This endpoint measures the untouched provisional WR SAGE v1 model. It does not optimize weights or create recommendation thresholds."
          },
          ...
          nextStep: {
            ...
            reason:
              ready
                ? "The frozen WR SAGE forecast has been matched to actual target-week outcomes. Review overall correlations, component correlations, rank agreement, Top-12/24/36 capture, and score-band behavior before changing WR weights."
                : "Resolve outcome retrieval failures before interpreting WR forecast-vs-actual validation."
          },
      ...
      console.error(
        "weekly-sage-wr-validation failed:",
        error
      );
      ...
      return jsonResponse(
        ...
        {
          error:
            "Could not validate Weekly SAGE WR scores against actual outcomes.",
