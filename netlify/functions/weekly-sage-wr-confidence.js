// netlify/functions/weekly-sage-wr-confidence.js
//
// WEEKLY SAGE — WR CONFIDENCE ADJUSTMENT
//
// PURPOSE
// -------
// Apply evidence maturity to the provisional raw WR Role and Production
...
// They will be validated during the WR historical backtest.
//
...
async function fetchComponents({
  ...
  if (
    ...
    throw new Error(
      "Unexpected Weekly SAGE WR component-score schema."
    );
  }
...
function buildExplanation({
  ...
  return (
    `${name} has ${gamesUsed} prior games of WR evidence. ` +
  ...
  prebuiltSnapshot
      ...
      if (
        ...
        throw statusError(
          ...
          {
            error:
              "WR confidence adjustment requires a WR.",
      ...
      if (
        ...
        throw statusError(
          ...
          {
            error:
              "WR component evidence is incomplete.",
      ...
      if (
        ...
        throw statusError(
          ...
          {
            error:
              "One or more WR confidence-adjusted component scores could not be calculated.",
      ...
      return {
          ...
          methodology: {
            ...
            status:
              "First-pass provisional WR confidence methodology.",
            ...
            important:
              "Confidence adjusts trust in the observed component score. It does not change the underlying WR Role or Production methodology."
          },
          ...
          nextStep: {
            ...
            reason:
              "WR Role and Production confidence adjustments are available. Validate mature and smaller-sample WR profiles before composing the first final WR SAGE score."
          },
