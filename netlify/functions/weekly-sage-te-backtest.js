// netlify/functions/weekly-sage-te-backtest.js
//
// WEEKLY SAGE — TE MULTI-WEEK BACKTEST
//
// PURPOSE
// -------
// Aggregate multiple historical Weekly SAGE TE validation weeks
...
// ------------------------
//
//   - combined TE player-week sample
//   - Pearson correlation
...
//   Weeks 5 through 17
//
// This reuses the same broad WR/RB validation window (Weeks 5-17) as a
// starting default -- not a TE-specific calibration -- and gives TE SAGE
// enough early-season evidence before beginning the historical sample.
//
// ═══════════════════════════════════════════════════════════════════════
...
async function fetchValidationWeek({
  ...
  if (
    ...
    return {
      ...
      error:
        "Unexpected Weekly SAGE TE validation schema."
    };
  }
...
/*
  ...
  One observation = one TE who actually played in that week.
*/
  ...
  async function (
    ...
    try {
      ...
      /*
        STEP 1
        ------
        Retrieve each weekly TE validation result.
      ...
      */
      ...
      /*
        STEP 2
        ------
        Build one clean TE player-week dataset.
      */
      const observations =
        [];
      ...
      for (
        ...
        for (
          ...
          /*
            ...
            validation only includes played WRs.
          */
          if (
            observation.sageScore ===
              null ||
      ...
      */
      ...
      return jsonResponse(
        200,
        {
          ...
          methodology: {
            ...
            unitOfObservation:
              "One TE player-week in which the player actually participated in the target-week game.",

            prediction:
              "Frozen pre-game Weekly SAGE TE score.",

            outcome:
              "Actual target-week fantasy points.",

            leakageProtection:
              "This endpoint consumes weekly-sage-te-validation results. Target-week actual performance never feeds back into the historical SAGE prediction.",
            ...
            regression:
              "Simple ordinary least squares regression of actual fantasy points on pre-game TE SAGE Score.",
            ...
            important:
              "This backtest measures historical predictive relationship. It does not optimize TE weights or create recommendation thresholds. TE weights (55/40/5) remain the Phase 1 placeholder until this backtest has actually been run and reviewed."
          },
          ...
          nextStep: {
            ...
            reason:
              ready
                ? "The multi-week TE forecast-vs-actual dataset is clean. Review combined SAGE correlations, Role / Production / Matchup relationships, regression fit, and score-band calibration before running TE weight sensitivity."
                : "Resolve retrieval failures or unready validation weeks before interpreting the TE backtest or changing SAGE weights."
          },
      ...
      console.error(
        "weekly-sage-te-backtest failed:",
        error
      );
      ...
      return jsonResponse(
        ...
        {
          error:
            "Could not build Weekly SAGE TE multi-week backtest.",
