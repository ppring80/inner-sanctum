...
assert(landing.includes('class="nav-link home" href="https://theinnersanctum.xyz/"'));
assert(landing.includes("onclick=\"window.location.assign('https://theinnersanctum.xyz/');return false;\""));
