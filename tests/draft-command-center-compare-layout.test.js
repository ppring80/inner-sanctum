...
assert.ok(source.includes('.ptable .compare-cell{width:88px;min-width:88px;text-align:center'));
assert.ok(source.includes('.ptable .compare-cell .cmp-row-btn{display:block;width:76px;margin:0 auto'));
